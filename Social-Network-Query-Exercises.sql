...
-- 4. Find all students who do not appear in the Likes table (as a student who
...
-- NOTE: Using `<` instead of `!=` for the `where` clause automatically
--    removes all instances of duplicate names and grades being printed.
